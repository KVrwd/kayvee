...
export default function ConnectDerivScreen() {
  ...
  const { addDerivAccount, markDerivPromptSeen } = useSession();
    ...
    <ScreenContainer>
      <View style={styles.wrap}>
        ...
        <Pressable 
          ...
          style={[styles.primaryButton, { backgroundColor: theme.accent, borderRadius: radius.lg, marginTop: 10 }]}
        >
        ...
        >
          {connecting ? (
            ...
            <Text style={[typography.button, { color: theme.buttonPrimaryText }]}>Connect</Text>
          )}
        </Pressable>
...
const styles = StyleSheet.create({
  ...
  primaryButton: { height: 56, alignItems: 'center', justifyContent: 'center', marginTop: 20 },
  skipButton: { marginTop: 18, paddingVertical: 10 },
});